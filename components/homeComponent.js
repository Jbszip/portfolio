  ...
  return (
      <main className={styles.main}>
        <div className="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
            <div className="mx-4 lg:mx-10">
              ...
              <div className="mt-8 space-y-5 text-center">
                <p className="items-center mx-2 text-center">
                  <span>¿Quién soy?</span> Joven estudiante proactivo, con conocimientos de frontend, autodidacta y entusiasta.
                </p>
          ...
          <div className= "h-96 lg:max-w-lg mx-auto">
            <img className="h-full rounded-md" src="/profile.png" alt="Imagen de perfil" />
          </div>
        </div>
        <ProyectoList />
        <ToolsList />
