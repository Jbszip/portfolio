...
export default function ToolsList() {
    ...
    return (
        <>
            <h3 className="font-bold uppercase text-center content-center justify-center text-2xl max-w-xs pb-1 mx-auto mt-2 border-b-2 border-blue-600">Herramientas</h3>
